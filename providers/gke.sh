...
get-env)
	...
	export_env "GKE_CLUSTER_NUM_NODES" "$GKE_CLUSTER_NUM_NODES"
	export_env "GKE_CLUSTER_MACHINE_TYPE" "$GKE_CLUSTER_MACHINE_TYPE"
	export_env "GKE_LOC_REGION" "$GKE_LOC_REGION"
	export_env "GKE_AUTH_FILE" "$GKE_AUTH_FILE"
	;;
